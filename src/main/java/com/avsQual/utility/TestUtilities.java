...
public class TestUtilities extends BaseClass {
	...
	public boolean is_PopupWindowDisplayedState()
	{
		WebElement popUp = driver.findElementByAccessibilityId("Content_String");
	...
	public void click_Close_alertmsg() throws InterruptedException {
		if (!IsElementVisibleStatus(driver.findElementByAccessibilityId("dispalyMessageTextBlock"))) {
	...
	public String creating_Foler(String path)
	{
//		String filePath = System.getProperty("user.home")+"\\Documents\\SyncIn";
	...
	public String get_AlertMsg_text() {
		WebElement Msg = driver.findElementByAccessibilityId("dispalyMessageTextBlock");//dispalyMessageTextBlock
	...
	//	return LogMsg.getAttribute("Name");
		try
		{
			...
			return checkingVisibilityOfElement(LogMsg, 5).getAttribute("Name");
		}
		catch (Exception e) {
			 LogMsg = driver.findElementByAccessibilityId("Content_String");
			 //checkingVisibilityOfElement(LogMsg, 5);
			return checkingVisibilityOfElement(LogMsg, 5).getAttribute("Name");
		}
	}
	
	public String get_OK_Popup()
	{
		WebElement ele = driver.findElementByAccessibilityId("Button0");
	...
	public void click_Cancel_popup() throws InterruptedException {
		...
		act.moveToElement(cancel_Btn).click(cancel_Btn).build().perform();
	}
	...
	public boolean is_PopUpWindowDisplayed()
	{
		WebElement ele = driver.findElementByAccessibilityId("Popup Window");
	...
	public String get_rightMsg_text() {
		//WebElement Msg = driver.findElementByXPath("//*[contains(text(),'Successfully.')]");
		WebElement Msg = driver.findElementByXPath("//*[contains(@id,'NormalToastView')]");
			//return FetchText(checkingVisibilityOfElement(Msg, 5));
...
//	 }
	 ...
	 public String  right_popup() {
		//WebElement pop=driver.findElement(By.xpath("[//*contains(text(),'Successfully')]"));
		 WebElement pop= driver.findElementByAccessibilityId("TitleText");
		 try {
			 return checkingVisibilityOfElement(pop, 10).getAttribute("Name");
		 }catch(Exception e) {
			 return checkingVisibilityOfElement(pop, 10).getAttribute("Name"); 
		 }
		//String pop1= pop.getAttribute("Name");
		//return FetchText(pop);
		// return pop.getAttribute("Name");

		// return FetchText(checkingVisibilityOfElement(pop, 5));
	}
}
